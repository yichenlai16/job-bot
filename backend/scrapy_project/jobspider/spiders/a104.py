...
#                 yield FormRequest(self.start_url+"&area="+str(area)+'&jobcat='+str(jobcat), callback=self.ro_requests, dont_filter=False)

#         for page in range(1, totalpage+1):
#             yield FormRequest(url+"&page="+str(page), dont_filter=False, callback=self.parse)
...
#             # print(url,totalpage)
#             for ro in range(1, 5):
#                 yield FormRequest(url=url+"&ro="+str(ro), method="GET", callback=self.extended_requests)
#         else:
#             for page in range(1, totalpage+1):
#                 yield FormRequest(url+"&page="+str(page), callback=self.parse)
...
#         jobCategory = [x['description'] for x in job_data['jobDetail']['jobCategory']]
...
#         remoteWork = job_data['jobDetail']['remoteWork']
#         delegatedRecruit = job_data['jobDetail']['delegatedRecruit']
#         roleDesc = [ x['description'] for x in job_data['condition']['acceptRole']['role']]
...
#         localLanguage = job_data['condition']['localLanguage']
#         specialty = [ x['description'] for x in job_data['condition']['specialty']]
#         skill = [ x['description'] for x in job_data['condition']['skill']]
